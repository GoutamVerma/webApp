...
import { SILENT_SIGN_IN_STATE, Storage, TOKEN_REQUEST_CONFIG_KEY } from "../constants";
...
export const MainThreadClient = (instanceID, config, getAuthHelper) => __awaiter(void 0, void 0, void 0, function* () {
     ...
     */
    const trySignInSilently = (additionalParams = {}) => __awaiter(void 0, void 0, void 0, function* () {
        return yield _authenticationHelper.trySignInSilently(constructSilentSignInUrl, requestAccessToken, _sessionManagementHelper, additionalParams);
    });
